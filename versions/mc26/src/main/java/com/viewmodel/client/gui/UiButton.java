...
final class UiButton extends AbstractWidget implements NanoPaintable {
    enum Style { PRIMARY, SECONDARY, DANGER, WIDE }

    private final Runnable action;
    private final Style style;

    UiButton(int x, int y, int width, int height, Component label, Style style, Runnable action) {
